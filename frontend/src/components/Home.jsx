...
import { Craft1 } from "../utils/constant";
import { Craft2 } from "../utils/constant";
...
const Home = () =>{
    return(
      ...
      <div className="px-6 md:px-16 py-10 flex flex-col md:flex-row gap-6 items-start">
        ...
        {/* Image column */}
        <div className="w-full md:w-1/3 flex flex-col gap-6 items-center md:items-end shrink-0">
          <img
            src={Craft1}
            alt="Craft 1"
            className="w-full max-w-sm h-88 md:h-[31rem] object-cover rounded-lg shadow-lg"
